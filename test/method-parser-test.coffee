...
util = require 'util'
fs = require 'fs'
MethodParser = require('../lib/method-parser')
parse = MethodParser.parse

assert.equals = (actual, expected)->
    assert isEqual(actual, expected), "expected #{util.inspect actual} to equal #{util.inspect expected}"
    return
...
describe 'method-parser', ->
    ...
    MethodParser.FACTORY_FNS = ALL_FNS
